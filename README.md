...
Вы можете обращаться с помощью ключа к чужим ресурсам. Тут оступны фильтры.
...
Этот метод требует аунтификации. Список будет предоставлен от вашего имени и, например получив ссылку на скачивание или ссылку на предпросмотр, кто-то другой не сможет воспользоваться этой ссылкой т.е. в такие момент вам нужно будет работать с одним ресурсом. Так устроен Яндекс.Диск.
...
Описанное ранее справедливо и тут, кроме расшифровывания зашифроанных файлов.
