 ...
 */
class TrashResourceList extends Entity
{
    ...
    /**
     * @return TrashResource[] List of items
     */
    ...
    /**
     * @return string Path to the resource the list for that was built
     */
